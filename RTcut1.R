...
# Example usage:
# Call the function to calculate and plot CUMP thresholds for a given participant (e.g., participant row 5) with the first csv file being associated with introduction of response times, followed by the data file (response vectors).
